...
public class LOGOTOP5_007 extends PApplet {
...
public synchronized void draw(){
 ...
 /**
  ...
  public synchronized void oscEvent(OscMessage theOscMessage) {
    ...
    String types2 = theOscMessage.typetag();
    println("types2: "+types2);
...
class World {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "LOGOTOP5_007" };
    if (passedArgs != null) {
